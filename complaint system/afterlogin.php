...
<i class="fa fa-reorder" onclick="callsh()" style="cursor:pointer;font-size:24px;margin:10px 2px 0px 20px;color:white"></i>		
  ...
  <ul class="navbar-nav" style="width:100%;background-color:#17a2b86e;">
	...
	<li class="nav-item"  >
      <a class="btn btn-dark btn1" onclick="feedback()" href="#">Write feedback</a>
    </li><br />
    <li class="nav-item">
	...
	<li class="nav-item" >
      ...
      <a class="btn btn-dark btn1" onclick="changepass()" style="display:none;" id="c_pass" href="#">Change password</a>
		...
		<div id="main" style="width:78%;float:left;" >
			...
			<h4>>Dashboard<hr /></h4>
				<div id="file1" onclick="feedback()" style="cursor:pointer;">
					<i class="fa fa-file-text" style=""></i>
					<p id="file12" style="display:block;font-size:15px;text-align:center;">Write FeedBack<div id="pen"><?php echo $pend; ?></div></p>
				</div>
				<div id="file1" onclick="pending()" style="cursor:pointer;">
					<i class="fa fa-file-text" style=""></i>
					<p id="file12" style="display:block;font-size:15px;text-align:center;">Pending<div id="pen"><?php echo $pend; ?></div></p>
				</div>
					<div id="file2" onclick="inpro()" style="cursor:pointer;">
						<i class="fa fa-file-text" style=""></i>
						<p id="file22" style="display:block;font-size:15px;text-align:center;">in progress<div id="pen2"><?php echo $inpro; ?></div></p>
					</div>
						<div id="file3" onclick="completed()" style="cursor:pointer;">
							<i class="fa fa-file-text" style=""></i>
							<p id="file32" style="display:block;font-size:15px;text-align:center;">Completed<div id="pen3"><?php echo $compl; ?></div></p>
						</div>
			</div>
			...
			<!----------------------------------------------------------------------------------------editinfo-->
						<!----------------------------------------------------------------------------------------Feedback-->
				<div class="" id="feedback" style="width:100%;display:none;border-radius:15px;padding:15px;margin:10px;background-color:rgba(32, 76, 5, 0.1);border:1px solid aqua;">
				<h4>>Write a feedback<hr /></h4>
				<form class="form" action="usermakecomp.php" method="POST" style="width:100%;" enctype="multipart/form-data">
					<span id="span">Subject </span>
					...
					<br/>
					<br/>
					<span id="span">Level of Feedback </span><input type="text" name="nature" class="form-control in2" placeholder="Good/Average/Disappointed ...."><br />
					<span id="span">Complaint</span>
					<textarea name="comp" class="form-control in1" placeholder="Feel free to write. Your Feedback is secure." style="height:200px;"></textarea><br />
					<br />
